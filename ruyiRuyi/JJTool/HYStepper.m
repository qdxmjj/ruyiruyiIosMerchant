...
-(void)actionForTextFieldValueChanged: (UITextField*)sender{
    if ([sender isEqual:_valueTF]) {
        self.value = [sender.text floatValue];
    }
}
...
-(void)setValue:(CGFloat)value{
    ...
    if (self.delagate && [self.delagate respondsToSelector:@selector(valueChangedWithValue:)]) {
        
        [self.delagate valueChangedWithValue:_value];
    }
