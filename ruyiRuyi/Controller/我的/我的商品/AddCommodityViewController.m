...
-(BOOL)textFieldShouldBeginEditing:(UITextField *)textField{
    ...
    }else if(textField == self.commodityTypeField){
...
-(void)viewWillLayoutSubviews{
    ...
    self.headImgBtn.layer.borderColor = [[UIColor lightGrayColor] CGColor];
...
-(UIButton *)headImgBtn{
    ...
    if (!_headImgBtn) {
        ...
        [_headImgBtn setImage:[UIImage imageNamed:@"ic_head"] forState:UIControlStateNormal];
